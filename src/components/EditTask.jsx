...
function EditTask({ editTaskVisibility, cancelEditTask, task, setRefresh }) {
    ...
    useEffect(() => {
        if (task) {
            ...
            setChecklists(task.checklists.map(checklist => ({
                ...checklist,
                id: checklist._id
            })));
        }
    ...
    const handlesave = async () => {
        ...
        const response = await dispatch(editTask(editedTask))
    ...
    return (
        <div className="create-task-modal" style={{ display: editTaskVisibility }}>
            <div className="create-task-modal__content">
                ...
                <div className="create-task-modal__actions">
                    ...
                    <div className="create-task-modal__btn-group">
                        <button className="create-task-modal__btn create-task-modal__btn--cancel" onClick={cancelEditTask}>
                            Cancel
                        </button>
